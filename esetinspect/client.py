...
class EsetInspectClient:
    ...
    def _api_request(self, endpoint: str, *args, method: str = "GET", **kwargs) -> httpx.Response:
        uri = f"/api/v1{endpoint}"
        return self._raw_request(uri, *args, method=method, **kwargs)

    def _frontend_request(self, endpoint: str, *args, method: str = "GET", **kwargs):
        uri = f"/frontend{endpoint}"
        return self._raw_request(uri, *args, method=method, **kwargs)

    def _raw_request(self, uri: str, *args, method: str = "GET", **kwargs) -> httpx.Response:
    ...
    def api_get(self, endpoint: str, *args, **kwargs):
        return self._api_request(endpoint, *args, method="GET", **kwargs)

    def api_post(self, endpoint: str, *args, **kwargs):
        return self._api_request(endpoint, *args, method="POST", **kwargs)

    def api_put(self, endpoint: str, *args, **kwargs):
        return self._api_request(endpoint, *args, method="PUT", **kwargs)

    def api_delete(self, endpoint: str, *args, **kwargs):
        return self._api_request(endpoint, *args, method="DELETE", **kwargs)

    def frontend_get(self, endpoint: str, *args, **kwargs) -> httpx.Response:
        return self._frontend_request(endpoint, *args, method="GET", **kwargs)

    def frontend_post(self, endpoint: str, *args, **kwargs) -> httpx.Response:
        return self._frontend_request(endpoint, *args, method="POST", **kwargs)

    def frontend_put(self, endpoint: str, *args, **kwargs) -> httpx.Response:
        return self._frontend_request(endpoint, *args, method="PUT", **kwargs)

    def frontend_delete(self, endpoint: str, *args, **kwargs) -> httpx.Response:
